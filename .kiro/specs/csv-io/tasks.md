...
- [x] 1. 基盤整備：Policy 拡張とルート追加

- [x] 1.1 各 Policy に CSV 操作権限メソッドを追加する
...
- [x] 1.2 CSV アクションと `/setup` エンドポイントをルートに追加する
...
- [x] 2. CsvExportService 実装

- [x] 2.1 備品・貸出履歴のエクスポートメソッドを実装する
...
- [x] 2.2 カテゴリ・ユーザーのエクスポートメソッドを実装する
...
- [x] 3. CsvImportService 実装

- [x] 3.1 カテゴリ・ユーザーのインポートメソッドを実装する
...
- [x] 3.3 貸出履歴インポートメソッドと在庫再計算を実装する
...
- [x] 4. SetupsController の実装（初期管理者作成画面）

- [x] 4.1 SetupsController とアクションを実装する
...
- [x] 5. 備品 CSV エクスポート・インポート機能

- [x] 5.1 (P) EquipmentsController に CSV アクションを追加する
...
- [x] 5.2 (P) 備品一覧ビューに CSV ダウンロードボタンとインポートフォームを追加する
...
- [x] 6. 貸出履歴 CSV エクスポート・インポート機能

- [x] 6.1 (P) LoansController・Admin::LoansController に CSV アクションを追加する
...
- [x] 6.2 (P) 貸出一覧ビューに CSV ダウンロードボタンとインポートフォームを追加する
...
- [x] 10.1 (P) CsvExportService のユニットテストを実装する
...
- [x] 10.2 (P) CsvImportService のユニットテストを実装する
